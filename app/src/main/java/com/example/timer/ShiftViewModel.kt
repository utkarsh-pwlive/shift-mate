...
class ShiftViewModel(application: Application) : AndroidViewModel(application) {
    ...
    var shiftHours: String
        get() = _shiftHours
        set(value) {
            _shiftHours = value; prefs.edit { putString("shiftHours", value) }
        }
    ...
    var shiftMinutes: String
        get() = _shiftMinutes
        set(value) {
            _shiftMinutes = value; prefs.edit { putString("shiftMinutes", value) }
        }
    ...
    var hour: String
        get() = _hour
        set(value) {
            _hour = value; prefs.edit { putString("hour", value) }
        }
    ...
    var minute: String
        get() = _minute
        set(value) {
            _minute = value; prefs.edit { putString("minute", value) }
        }
    ...
    var second: String
        get() = _second
        set(value) {
            _second = value; prefs.edit { putString("second", value) }
        }
    ...
    var selectedPeriod: String
        get() = _selectedPeriod
        set(value) {
            _selectedPeriod = value; prefs.edit { putString("selectedPeriod", value) }
        }
    ...
    var checkoutTimeStr: String
        ...
        set(value) {
            _checkoutTimeStr = value; prefs.edit { putString("checkoutTimeStr", value) }
        }
    ...
    var timeLeftHoursValue: Double
        ...
        set(value) {
            _timeLeftHoursValue = value; prefs.edit {
                putString("timeLeftHours", value.toString())
            }
        }
    ...
    var shiftCompleted: Boolean
        get() = _shiftCompleted
        set(value) {
            _shiftCompleted = value; prefs.edit { putBoolean("shiftCompleted", value) }
        }
